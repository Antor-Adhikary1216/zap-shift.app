        ...
        <div className='p-10 mx-auto'>
          ...
          <div className="flex justify-between my-10 px-25">
                <div className="fro">
                    ...
                    <h1 className='text-3xl my-2 font-semibold'>Create an Account</h1>
                    <p className=' text-[18px]'>Register with ZapShift</p>
                    <form className='my-5'>
                    </form>
                        <label>
                            <p className='my-1 text-md font-medium'>Name</p>
                            <input type="email" name='name' placeholder='Enter your Name' className='border lg:h-[30px] text-[16px] px-2 py-4 rounded-xl border-[#CBD5E1] lg:w-[300px] ' />
                        </label>
                        <label>
                        ...
                        <label>
                            ...
                            <button className='w-full p-2 rounded-full my-2 text-[18px] font-medium bg-[#CAEB66]'> Login </button>
                               <p className='text-[#71717a]'> Don’t have any account? <NavLink to="/Login">LogIn</NavLink></p>
