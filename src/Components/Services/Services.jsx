...
const Services = () => {
  return (
    <main className="my-6 overflow-hidden rounded-3xl bg-white shadow-sm sm:my-10">
      ...
      <section className="px-5 py-12 sm:px-10 lg:px-16 lg:py-16">
        ...
        <div className="mt-10 grid gap-5 md:grid-cols-2 lg:grid-cols-3">
          {services.map(({ icon: Icon, title, description, tag }) => (
            <article key={title} className="group rounded-2xl border border-slate-200 p-6 transition duration-300 hover:-translate-y-1 hover:border-[#c5ed58] hover:shadow-xl hover:shadow-[#03373D]/5 sm:p-7">
      ...
      <section className="mx-5 mb-12 rounded-3xl bg-[#f1f5e8] px-6 py-10 sm:mx-10 sm:px-10 lg:mx-16 lg:mb-16 lg:flex lg:items-center lg:justify-between lg:px-12">
        <div>
        ...
        <div className="mt-6 flex flex-wrap gap-3 lg:mt-0">
          <NavLink to="/bargainnig" className="btn rounded-xl border-[#03373D] bg-transparent text-[#03373D] hover:bg-[#03373D] hover:text-white">Check pricing</NavLink>
          <NavLink to="/send_a_parcel" className="btn rounded-xl border-[#03373D] bg-[#03373D] text-white hover:border-[#0a4a52] hover:bg-[#0a4a52]">Book delivery</NavLink>
        </div>
      </section>
    </main>
  )
